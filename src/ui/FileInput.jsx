    ...
    return (
      <Fragment>
        <input
          ...
          type="file"
          className="w-full bg-transparent rounded-md border border-slate-200 hover:border-slate-300 shadow  outline-none transition-all duration-200 file:mr-5 file:border-collapse file:cursor-pointer file:border-0 file:border-r file:border-solid file:border-stroke dark:file:border-dark-3 file:bg-orange-400 dark:file:bg-dark-2 file:py-3 file:px-5 file:text-white    active:border-primary disabled:cursor-default disabled:bg-gray-2"
        />
        ...
        >
          <div>
            <input
              ...
              name={name}
              id={id}
              className="sr-only text-slate-500 font-medium"
            />
