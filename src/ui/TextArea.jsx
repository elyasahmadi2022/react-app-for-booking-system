...
function TextArea({ id, placeholder, register, disabled, row }) {
  return (
    <div className="relative">
      <textarea
        ...
        className="w-full bg-transparent text-slate-500  border-slate-200 hover:border-slate-300  duration-200 shadow-md  rounded-sm border   p-3 pl-12  outline-none transition-all  disabled:cursor-not-allowed disabled:bg-slate-300"
      />
